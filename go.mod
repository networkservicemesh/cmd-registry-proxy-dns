...
require (
	...
	github.com/networkservicemesh/sdk v0.5.1-0.20260831132601-c0925ce21a09
...
require (
	...
	github.com/networkservicemesh/api v1.19.0-rc.1.0.20260824081105-7ccb73c2b1b0 // indirect
