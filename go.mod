...
require (
	...
	github.com/networkservicemesh/sdk v0.5.1-0.20250716141930-3185db764c2f
...
require (
	...
	github.com/networkservicemesh/api v1.15.0-rc.1.0.20250625083423-2e0c8496e4e3 // indirect
